    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th style="margin-inline: 20px; background-color:grey" scope="col">Studio</th>
            </tr>
        </thead>
        <tbody align="middle">
            @foreach ($mailDataStudio as $key => $data)
            <tr>
        ...
        <td style="margin-inline: 20px ; background-color:lemonchiffon" ><p>{{ $data['studio_id'] }}</p></td>
    </tr>
    @endforeach
        </tbody>
    </table>
