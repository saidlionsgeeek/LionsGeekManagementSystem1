...
<!-- Modal -->
<div class="modal fade" id="example{{ $studio->id }}Modal" tabindex="-1"
    aria-labelledby="example{{ $studio->id }}ModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="example{{ $studio->id }}ModalLabel">Make a New Studio Reservation</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('reservation_studio.create', $studio->id) }}" method="POST">
