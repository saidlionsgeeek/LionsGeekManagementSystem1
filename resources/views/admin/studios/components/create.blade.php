<div class=" text-center">
    <button type="button" class="btn btn-warning mt-5 mb-5 text-center fs-4" data-bs-toggle="modal"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action={{ route('admin.studio.store') }} method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label class="form-label" for="name">Ajoutez nom de Studio</label>
                        <input class="form-control" type="text" name="name" id="name">
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="description">Ajoutez une description</label>
                        <textarea class="form-control" type="text" name="description" id="description" cols="30" rows="4"></textarea>
                    </div>
